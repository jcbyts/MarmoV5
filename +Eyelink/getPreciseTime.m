...
%eyelink.getPreciseTime    get a rough estimate about the eyelink time
%
...
% jk wrote it 2014
    ...
    if maxTimeThreshold>120
        error('Eyelink: getPreciseTime: choose a lower maxTimeThreshold or comment this line out. Your are risking a deadlick since this is running at maximum priority.')
    end
