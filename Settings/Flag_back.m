...
P.stimDur = 0.15;  % duration of peripheral stim (offset before sac)
...
P.range = 48; % lower contrast probe, 127;
...
P.orinum2 = 4;   % set to zero if not
...
P.cpd2 = 8;  % must be scaled by pixperDeg
