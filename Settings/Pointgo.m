...
S.protocolTitle = 'Point Cue Task';
...
P.SamplingDirections = 4; % 1 all 8, 2 - cardinal, 3 - diagonal, 4 - show 8 apertures
...
P.dotFade = -1.5; %-1.5; %-0.4; %increment to increase lum per frame
...
P.apertureFade = 0.3; %increment to increase lum per frame
...
P.phase = 1;   % not used anymore (keep back compatible)
P.angle = 0;   % not used anymore (keep back compatible)
%*******
P.runType = 1;
