...
P.stimDur = 0.032;
S.stimDur = 'Duration of stim presentation (s):';
P.stimWait = 0.288;
S.stimWait = 'Time to acquire target (s):';
P.fixJitter = 0.05;  % jitter onset of post-sac target
S.fixJitter = 'Jitter in time to reappear target (s):';
P.probchange = 0.50; % prob of change stim on sac landing
S.probchange = 'Prob of change stim on landing:';
%********
P.hortarget = 45; % range in degs plus/minus from horizontal
S.hortarget = 'Range from horizontal (degs)';
%*****
P.fixRadius = 2.0;  
...
%************** Probe properties
P.proberadius = 3.5;  % radius of target is dva
...
if (P.noisetype == 1)
    ...
    P.probNoise = 0.15;  % fraction of frames with orientation instead of blank
