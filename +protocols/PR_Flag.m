classdef PR_Flag < handle
  ...
  properties (Access = public)
       ...
       fadeframes double = 1;     % if more than one, then fade in stim
       fadecount double = 1;      % counting up to fadeframes
  ...
  methods (Access = public)
    ...
    function initFunc(o,S,P);
       ...
       o.fadeframes = P.fadeframes+1;
       o.hProbe = cell(1,o.fadeframes);
       for k = 1:o.fadeframes
    ...
    function P = next_trial(o,S,P);
            ...
            for zk = 1:(o.fadeframes-1)
                o.hProbe{zk}.position = [(S.centerPix(1) + round(P.xDeg*S.pixPerDeg)),(S.centerPix(2) - round(P.yDeg*S.pixPerDeg))];
                o.hProbe{zk}.radius = round(P.radius*S.pixPerDeg);
                o.hProbe{zk}.orientation = P.ori; % vertical for the right
                o.targori = P.ori;
                o.hProbe{zk}.phase = P.phase;
                o.hProbe{zk}.cpd = P.cpd;
                o.hProbe{zk}.cpd2 = P.cpd2;
                if (o.fadeframes > 2)
                   rango = floor( ((zk-1) * P.range)/(o.fadeframes-1) );
                else
                   rango = P.range;
                end
                o.hProbe{zk}.range = rango;
            ...
            o.hProbe{o.fadeframes}.position = [(S.centerPix(1) + round(P.xDeg*S.pixPerDeg)),(S.centerPix(2) - round(P.yDeg*S.pixPerDeg))];
            o.hProbe{o.fadeframes}.radius = round(P.radius*S.pixPerDeg);
            o.hProbe{o.fadeframes}.phase = P.phase;
            o.hProbe{o.fadeframes}.cpd = P.cpd;
            o.hProbe{o.fadeframes}.cpd2 = P.cpd2;
            o.hProbe{o.fadeframes}.range = P.range;
            if isnan(P.postori)
                o.hProbe{o.fadeframes}.orientation = 0;
                o.hProbe{o.fadeframes}.phase = 0; % white Gabor blob
                o.hProbe{o.fadeframes}.cpd = 0;
                o.hProbe{o.fadeframes}.cpd2 = NaN;
                o.hProbe{o.fadeframes}.range = 0; % lowest con, hardly visible? 
            else
                o.hProbe{o.fadeframes}.orientation = P.postori; % vertical for the right
            end
            o.changori = P.postori;
            o.hProbe{o.fadeframes}.square = logical(P.squareWave);
            o.hProbe{o.fadeframes}.bkgd = P.bkgd;
            o.hProbe{o.fadeframes}.transparent = -P.probecon;
            o.hProbe{o.fadeframes}.updateTextures();
    ...
    function drop = state_and_screen_update(o,currentTime,x,y) 
        ...
        switch o.state
            ...
            case 4    % waiting for him to leave fixation 
                ...
                if (o.P.fixation == 0)
                    if (currentTime < o.stimTime + o.P.stimDur)
                       ...
                       o.hProbe{o.fadecount}.beforeFrame();
                       if (o.fadecount < (o.fadeframes - 1))
                           o.fadecount = o.fadecount + 1;
                       end
            ...
            case 5    % saccade in flight, dim fixation, just in case not done before
                ...
                if (o.P.fixation == 0)
                    o.hProbe{o.fadeframes}.beforeFrame();
                end
