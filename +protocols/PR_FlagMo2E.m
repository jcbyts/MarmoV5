classdef PR_FlagMo2E < handle
  ...
  methods (Access = public)
    ...
    function P = next_trial(o,S,P);
            ...
            o.deltaOri = 0;
            if ~isnan(P.postori)
                P.postori = P.ori;  %all predictive for now
...
%                 end
            ...
            for zk = 1:o.targnum
                ...
                if (o.P.motionStimulus)
                    ...
                    o.hProbe{zk}.lifetime=15; %how long the dots last
            ...
            for zk = 1:o.targnum
                ...
                if (o.P.motionStimulus)
                    ...
                    o.hProbe{o.targnum+zk}.lifetime=15; %how long the dots last
