classdef PR_Forage3 < handle
  ...
  methods (Access = public)
            ...
            if (itfix > 0)
                if ~o.FixTime  %first detection, set the time
                    ...
                    if (currentTime > (o.FixTime + o.P.holdDur))
                        if (o.targOri < o.oriNum) 
                             o.hProbe{o.oriNum}.position = o.hProbe{o.targOri}.position;
                             o.targOri = o.oriNum;
                        end
                    end
                    %***** 
                   if ( (currentTime - o.FixTime) > (2*o.P.holdDur) )
                         drop = 1;  % give reward
                ...
                if (o.state < 2)
                   ...
                   if (o.stimOn)
                       if (currentTime > (o.stimOn+o.P.stimDur))
                           o.ProbeHistory(o.PFrameCount,3) = o.targOri + 0.1;
                       end
                   end
                else
                   if (o.state == 3)
    ...
    function drop = state_and_screen_update(o,currentTime,x,y) 
        ...
        % Draw probe stimuli
        if (o.state < 2)
           if (currentTime <= (o.stimOn + o.P.stimDur)) || o.FixTime
